...
// check for alignment errors
	...
	printf("ex: AddressErrorException\n");
...
// from the virtual address
	...
	if (entry == NULL) {				// not found
			...
			printf("ex: PageFaultException entry null\n");
